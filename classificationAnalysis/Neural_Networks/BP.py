...
"""
  ...
  Datetime: 2021/9/8 22:45
  Software: PyCharm
  Profile: BP(back propagation)神经网络是1986年由Rumelhart和McClelland为首的科学家提出的概念，是一种按照误差逆向传播算法训练的多层前馈神经网络，是应用最广泛的神经网络。
  它的基本思想是梯度下降法，利用梯度搜索技术，以期使网络的实际输出值和期望输出值的误差均方差为最小。
  https://blog.csdn.net/qq_41398808/article/details/90904934
"""
...
if __name__ == '__main__':
    # 基于神经网络的马疝病死亡预测数据集
    dataset, labelset = loaddataset('../Data/horse-colic.txt')
