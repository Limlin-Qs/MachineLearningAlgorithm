...
# plt.scatter(X[y_kmeans == 5, 0], X[y_kmeans == 5, 1], s=100, c='purple')
# plt.scatter(X[y_kmeans == 6, 0], X[y_kmeans == 6, 1], s=100, c='orange')
# plt.scatter(X[y_kmeans == 7, 0], X[y_kmeans == 7, 1], s=100, c='gray')
# plt.scatter(X[y_kmeans == 8, 0], X[y_kmeans == 8, 1], s=100, c='pink')
